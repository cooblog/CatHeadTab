export const en = {
  ...
  'auth.usernameHint': '4–15 characters, letters, numbers, and underscores only',
  'auth.invalidUsername': 'Username must be 4–15 characters, using only letters, numbers, and underscores.',
